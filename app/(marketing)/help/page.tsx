...
// Filing types in display order for the document guide section
...
export default async function HelpPage() {
  ...
  const documentSections = FILING_DISPLAY_ORDER
  ...
  return <HelpContent documentSections={documentSections} />;
}

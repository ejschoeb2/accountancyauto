...
const PUBLIC_ROUTES = ["/login", "/signup", "/forgot-password", "/auth/callback", "/auth/signout", "/auth/reset-password", "/pricing", "/setup", "/invite/accept", "/portal", "/news", "/changelog", "/help", "/privacy", "/terms", "/guides", "/about"];
